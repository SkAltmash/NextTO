...
import {
  ScrollText, Mail, ChevronRight, Rocket, UserCheck,
  ShoppingCart, KeyRound, AlertTriangle, PenLine, MessageCircle,
} from 'lucide-react';
...
const sections = [
  {
    ...
    content:
      'NextTo provides a platform for ordering products and services from local businesses.',
    list: null,
  },
  {
  ...
  },
  {
    ...
    content:
      'All orders placed through NextTo are subject to availability and acceptance by the respective business.',
    list: null,
  },
  {
  ...
  },
  {
    ...
    content:
      'NextTo is not responsible for delays, interruptions, or losses resulting from circumstances beyond our reasonable control.',
    list: null,
  },
  {
    title: 'Modifications',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50/30 pb-28 md:pb-16">
      <SEO
        ...
        description="NextTo's Terms of Service — read the terms and conditions that govern your use of our platform and delivery services."
        canonical="/terms-of-service"
        keywords={['terms of service', 'terms and conditions', 'NextTo terms']}
      />

      {/* Hero header */}
      <div className="relative bg-white border-b border-slate-100 overflow-hidden">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-blue-50/40 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10">
          ...
          <p className="text-slate-500 text-sm sm:text-base font-medium mt-4 leading-relaxed max-w-xl">
            By using NextTo, you agree to the following terms and conditions.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-5">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-base sm:text-lg font-black text-slate-900">Contact</h2>
          </div>
